...
function update(){
	...
	$.post("<%=Const.ROOT%>laoshi/update_pwd",{"loginpw":newpass,"oldPass":oldPassword},function(data){
		alert(data.msg);
		if(data.status==0){
			...
			<div class="admin-content-body">
				<div class="am-cf am-padding am-padding-bottom-0">
					<div class="am-fl am-cf">
						<strong class="am-text-primary am-text-lg">首页</strong> / <small>老师密码修改</small>
					</div>
				</div>
				<hr>
