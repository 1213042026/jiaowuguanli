  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">首页</strong> / <small>公告信息管理</small></div>
      </div>
      <hr>
      <div class="am-g">
      ...
      <div class="am-g">
        <div class="am-u-sm-12">
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tbody>
              <c:forEach items="${requestScope.list}" var="gonggao" varStatus="st">
              <!-- 循环开始 -->
              <tr>
                <td>${st.count}</td>
                <td>${gonggao.title}</td>
                <td><div style="width:300px;line-height:25px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden;">${gonggao.content}</div></td>
                <td>${gonggao.addtime}</td>
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      <button type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="toUpdate('${gonggao.id}')"><span class="am-icon-pencil-square-o"></span> 编辑</button>
                      <button type="button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="doDelete('${gonggao.id}')"><span class="am-icon-trash-o"></span> 删除</button>
                    </div>
                  </div>
                </td>
              </tr>
		...
		<form class="am-form" name="addForm" action="add" method="post">
			<div class="am-g am-margin-top"><!--  style="margin-top:4px;" -->
				  ...
				  <div class="am-u-sm-9 am-u-md-9 am-u-end col-end">
					<input type="text" name="title" class="am-input-sm" placeholder="请输入公告标题" required>	
				  </div>
				</div>
				<div class="am-g am-margin-top">
				  ...
				  <div class="am-u-sm-9 am-u-md-9 am-u-end col-end">
					<textarea class="" rows="5" name="content" placeholder="请输入公告内容" required></textarea>	
				  </div>
				</div>
				<%--<div class="am-g am-margin-top">
				  <div class="am-u-sm-3 am-u-md-3 am-text-right">
				  ...
				  <div class="am-u-sm-9 am-u-md-9 am-u-end col-end">
					<input type="text" name="addtime" class="am-input-sm" placeholder="请选择时间" onclick="WdatePicker()" required>	
				  </div>
				</div>
			--%>
		...
		<form class="am-form" name="updateForm" action="update" method="post">
		    ...
		    <div class="am-g am-margin-top"><!--  style="margin-top:4px;" -->
				...
				<div class="am-g am-margin-top">
				  ...
				  <div class="am-u-sm-9 am-u-md-9 am-u-end col-end">
					<input type="text" name="addtime" class="am-input-sm" placeholder="请选择时间" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" required>	
				  </div>
				</div>
			--%>
			<div class="am-margin-top">
...
<script>
function doAdd(){
	$("#add-modal").modal({width:500,height:340});
}
