  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">首页</strong> / <small>教师信息管理</small></div>
      </div>
      <hr>
      <div class="am-g">
        <div class="am-u-sm-12 am-u-md-12">
            	<form class="am-form-inline" action="<%=Const.ROOT%>laoshi/list" method="post" id="searchForm">
           			<span style="margin-right:10px;">工号:</span><input type="text" name="bianhao" style="width:80px;"/>
      ...
      <div class="am-g">
        <div class="am-u-sm-12">
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tbody>
              <c:forEach items="${requestScope.list}" var="laoshi" varStatus="st">
              <!-- 循环开始 -->
              <tr>
                <td>${st.count}</td>
                <td>${laoshi.bianhao}</td>
                <td>${laoshi.xingming}</td>
                <td>${laoshi.xingbie}</td>
                <td>${laoshi.nianling}</td>
                <td>${laoshi.zymc}</td>
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                     	<%--<c:if test="${laoshi.status==0}">
                      		<button type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="doShenhe('${laoshi.id}')"><span class="am-icon-pencil-square-o"></span> 审核通过</button>
                      	</c:if>
                      --%>
                      <button type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="toUpdate('${laoshi.id}')"><span class="am-icon-pencil-square-o"></span> 编辑</button>
                      <button type="button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="doDelete('${laoshi.id}')"><span class="am-icon-trash-o"></span> 删除</button>
                    </div>
                  </div>
                </td>
              </tr>
		 	...
		 	<input type="hidden" name="type" value="1"/>
				<div class="am-g am-margin-top"><!--  style="margin-top:4px;" -->
				  ...
				  <div class="am-u-sm-9 am-u-md-9 am-u-end col-end">
					<input type="text" id="bianhao" name="bianhao" required placeholder="工号" onblur="checkExists()">	
				  </div>
				</div>
				<div class="am-g am-margin-top"><!--  style="margin-top:4px;" -->
				  <div class="am-u-sm-3 am-u-md-3 am-text-right">
  ...
  <div class="am-modal-dialog">
    ...
    <div class="am-modal-bd">
		...
		<form class="am-form" name="updateForm" action="update" method="post">
				  ...
				  <div class="am-u-sm-9 am-u-md-9 am-u-end col-end">
					<input type="text" name="xingming" class="am-input-sm" placeholder="请输入老师名称 " required>
				  </div>
				</div>
				<div class="am-g am-margin-top">
				  <input type="hidden" name="id"/>
				...
				<div class="am-g am-margin-top">
				  ...
				  <div class="am-u-sm-9 am-u-md-9 am-u-end col-end">
					<input type="text" name="nianling" class="am-input-sm" placeholder="请输入老师年龄" min="0" max="120" required>
				  </div>
				</div>
				<div class="am-g am-margin-top">
				  <div class="am-u-sm-3 am-u-md-3 am-text-right">
...
function checkExists(){
	...
	$.getJSON("<%=Const.ROOT%>laoshi/isExists",{"bianhao":bianhao},function(data){
		if(data.status!=0){
			alert(data.msg);
			return false;
		}
