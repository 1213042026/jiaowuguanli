  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">首页</strong> / <small>课程信息管理</small></div>
      </div>
      <hr>
      <div class="am-g">
      ...
      <div class="am-g">
        <div class="am-u-sm-12">
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tbody>
              <c:forEach items="${requestScope.list}" var="kecheng" varStatus="st">
              <!-- 循环开始 -->
              <tr>
                <td>${st.count}</td>
                <td><a href="#">${kecheng.mingcheng}</a></td>
                <td><a href="#">${kecheng.zymc}</a></td>
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      <button type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="toUpdate('${kecheng.id}')"><span class="am-icon-pencil-square-o"></span> 编辑</button>
                      <button type="button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="doDelete('${kecheng.id}')"><span class="am-icon-trash-o"></span> 删除</button>
                    </div>
                  </div>
                </td>
              </tr>
		...
		<form class="am-form" name="addForm" action="add" method="post">
				<div class="am-g am-margin-top"><!--  style="margin-top:4px;" -->
				  ...
				  <div class="am-u-sm-9 am-u-md-9 am-u-end col-end">
					<input type="text" name="mingcheng" class="am-input-sm" placeholder="请输入课程名称" required>	
				  </div>
				</div>
    ...
    <div class="am-modal-bd">
		...
		<form class="am-form" name="updateForm" action="update" method="post">
				...
				<div class="am-g am-margin-top">
				  ...
				  <div class="am-u-sm-9 am-u-md-9 am-u-end col-end">
					<select name="zhuanyeid" class="am-input-sm" id="zhuanye2" required>
					</select>	
				  </div>
				 </div>
			<div class="am-margin-top">
...
function doAdd(){
	$("#add-modal").modal({width:500,height:240});
}
...
function toUpdate(id){
	$.getJSON("detail"+id,function(data){
		if(data.status==0){
			...
			loadZhuanye("zhuanye2",data.data.zhuanyeid);
			$("#update-modal").modal({width:500,height:240});
		}
	})
}
</script>
